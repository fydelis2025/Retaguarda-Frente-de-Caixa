<%@ Page Title="CARGA PDV" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Realsoft_CargaPdv.aspx.cs" Inherits="_CargaPdv" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        &nbsp;</p>
    <p>
        <dx:ASPxGridView ID="DgLista" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css" CssPostfix="Office2003Blue" DataSourceID="CargaPdv" Width="907px">
...
<BorderBottom BorderStyle="NotSet"></BorderBottom>
        ...
        <asp:SqlDataSource ID="CargaPdv" runat ="server" ConnectionString="" ProviderName ="" SelectCommand=""></asp:SqlDataSource>
    </p>
    <p>
        <asp:RadioButton ID="RdTXT" runat="server" Text="Carga via Arquivo" />
&nbsp;|
        <asp:RadioButton ID="RdBD" runat="server" Text="Carga via Banco de Dados" />
&nbsp;|
        <asp:RadioButton ID="RdXML" runat="server" Text="Carga via XML" />
&nbsp;|&nbsp;&nbsp;
        <asp:Button ID="BtEnviar" runat="server" BackColor="SteelBlue" BorderStyle="Solid" ForeColor="White" OnClick="BtEnviar_Click" Text="Enviar" Width="114px" />
    </p>

    <p>
        <table style="width:100%;">
            <tr>
                <td class="bold">Lista de ECF</td>
                <td class="bold">Carga para Retaguarda</td>
                <td class="bold">Carga para pdv</td>
            </tr>
            <tr>
                <td class="auto-style1">
        <asp:CheckBoxList ID="ChLista" runat="server" DataSourceID="ListarIP">
        </asp:CheckBoxList>
                    <br />
                    <br />
                    <br />
                ...
                <td class="auto-style2">
                    <asp:CheckBoxList ID="ChCargaRetaguarda" runat="server" BorderColor="SteelBlue" BorderStyle="Solid" Height="157px" Width="210px">
                        <asp:ListItem>MOVIMENTAÇÃO ECF</asp:ListItem>
                        <asp:ListItem>REDUÇÃO Z</asp:ListItem>
                        <asp:ListItem>TESOURARIA</asp:ListItem>
                        <asp:ListItem>CARGA BALANÇA</asp:ListItem>
                        <asp:ListItem>VENDAS</asp:ListItem>
                        <asp:ListItem>CUPOM CANCELADOS</asp:ListItem>
                        <asp:ListItem>VENDAS FINALIZADAS</asp:ListItem>
                    </asp:CheckBoxList>
                </td>
                <td>
                    <asp:CheckBoxList ID="ChListaCarga" runat="server" BorderColor="SteelBlue" BorderStyle="Solid" Height="157px" Width="210px">
                        <asp:ListItem>ALTERAÇÃO PREÇOS</asp:ListItem>
                        <asp:ListItem>CARGA GERAL</asp:ListItem>
                        <asp:ListItem>PRODUTO NOVO</asp:ListItem>
                        <asp:ListItem>NOVOS CLIENTES</asp:ListItem>
                        <asp:ListItem>PREVENDA</asp:ListItem>
                    </asp:CheckBoxList>
                </td>
            </tr>
        </table>
    ...
    <p>
        <asp:SqlDataSource ID="ListarIP" runat ="server" ConnectionString="" ProviderName ="" SelectCommand=""></asp:SqlDataSource>
    &nbsp;</p>
</asp:Content>
