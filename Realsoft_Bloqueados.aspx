<%@ Page Title="CLIENTES BLOQUEADOS" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Realsoft_Bloqueados.aspx.cs" Inherits="_Bloqueados" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        <table style="width:100%;">
            <tr>
                <td colspan="3"><h2>
                    LISTA DE CLIENTES bloqueados</h2></td>
            </tr>
            <tr>
                <td colspan="3">
                    <asp:GridView ID="DgLista" runat="server" DataSourceID="CLIENTEBLOQUEADO" 
                        CellPadding="4" ForeColor="#333333" Width="895px" AllowPaging="True">
                    ...
                    <asp:SqlDataSource ID="CLIENTEBLOQUEADO" runat="server" 
                   ConnectionString=""
                   ProviderName="" 
                   SelectCommand=""> 
                  </asp:SqlDataSource>
