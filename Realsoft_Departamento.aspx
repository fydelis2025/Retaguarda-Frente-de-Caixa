<%@ Page Title="DEPARTAMENTO" Language="C#" AutoEventWireup="true"  CodeFile="Realsoft_Departamento.aspx.cs" Inherits="_Departamento" %>
...
<form id="form1" runat="server">
    <table style="width:100%;">
        <tr>
            <td colspan="2"  style="background-color: steelblue; font-family: Arial, Helvetica, sans-serif; font-size: x-large; color: #FFFFFF;" >&nbsp;DEPARTAMENTOS</td>
        </tr>
        <tr>
