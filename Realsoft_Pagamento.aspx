<%@ Page Title="RESUMO PAGAMENTO" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Realsoft_Pagamento.aspx.cs" Inherits="_Pagamento" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        <table style="width:100%;">
            <tr>
                <td colspan="3"><h2>
                    LISTA DE PAGAMENTOS</h2></td>
            </tr>
            <tr>
                <td colspan="3">
                    <asp:GridView ID="DgLista" runat="server" DataSourceID="PAGAMENTO" 
                    ...
                    <asp:SqlDataSource ID="PAGAMENTO" runat="server" ConnectionString="" ProviderName="" SelectCommand=""></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td>
