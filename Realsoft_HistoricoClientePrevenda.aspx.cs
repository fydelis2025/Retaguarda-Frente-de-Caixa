...
public partial class _HistoricoClientePrevenda : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            PREVENDA.SelectCommand = "SELECT PREVENDA, CPFCNPJ, CODIGO, DESCRICAO, QUANTIDADE, PRECOVENDA, TOTALLIQUIDO, FINALIZADO FROM REALSOFT_PREVENDA";
        }
    }
}