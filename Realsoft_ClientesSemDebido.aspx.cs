...
public partial class _Debitos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DEBITOS.ConnectionString = Realsoft_Parametro.parametroconexao;
                DEBITOS.ProviderName = Realsoft_Parametro.tipoconexao;
                DEBITOS.SelectCommand = "SELECT CLIENTE, DATAVENCIMENTO, [VALOR FATURA]AS 'FATURA', MOVIMENTACAOFATURA AS 'PAGAMENTO', COMPRASFATURA AS 'COMPRAS', VALORTOTALDEVIDO AS 'TOTALDEVIDO' FROM CONSULTAR_CLIENTES_SEMDEBITO";
            }
        }
        catch (Exception ex)
        {
