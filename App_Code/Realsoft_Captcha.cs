...
/// <summary>
/// Summary description for Realsoft_Captcha
/// </summary>
public class Realsoft_Captcha
{
	public Realsoft_Captcha(){}
    ...
    //Methods declaration
    public Realsoft_Captcha(string s, int width, int height)
    {
        this.text = s;
    ...
    private void SetDimensions(int width, int height)
    {
        if (width <= 0)
            throw new ArgumentOutOfRangeException("width", width,
                "Argumento fora do alcance, deve ser maior que zero.");
        if (height <= 0)
    ...
    private void GenerateImage()
    {
        ...
        hatchBrush = new HatchBrush(HatchStyle.Percent10, Color.SlateBlue, Color.SteelBlue);
